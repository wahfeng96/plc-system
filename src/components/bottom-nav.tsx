...
export function BottomNav() {
  ...
  const baseNav = role === 'admin' ? adminNav : role === 'teacher' ? teacherNav : guardNav
  const nav = (role === 'admin' || !allowedPages || allowedPages.length === 0)
    ? baseNav
    : baseNav.filter(l => allowedPages.includes(l.href))
